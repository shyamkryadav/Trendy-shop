...
export class CartServiceProxy {
    ...
    getCartItems(): Observable<ProductCart[]> {
        let url_ = this.baseUrl + "/api/Cart/GetCartItems";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCartItems(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCartItems(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<ProductCart[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ProductCart[]>;
        }));
    }

    protected processGetCartItems(response: HttpResponseBase): Observable<ProductCart[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(ProductCart.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
    ...
    addToCart(productId: number | undefined): Observable<ProductCart> {
    ...
    protected processAddToCart(response: HttpResponseBase): Observable<ProductCart> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ProductCart.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
    ...
    deleteCartItem(id: number | undefined): Observable<ProductCart> {
        let url_ = this.baseUrl + "/api/Cart/DeleteCartItem?";
        if (id === null)
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteCartItem(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<ProductCart>;
                }
            } else
    ...
    protected processDeleteCartItem(response: HttpResponseBase): Observable<ProductCart> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class UserServiceProxy {
    ...
    register(user: User): Observable<FileResponse> {
    ...
    login(user: User): Observable<FileResponse> {
...
export class ProductCart implements IProductCart {
    ...
    static fromJS(data: any): ProductCart {
